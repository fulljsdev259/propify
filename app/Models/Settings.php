...
//        'comment_update_timeout' => 'integer',
    ...
    public function transformAudit(array $data): array
    {
        ...
        if (key_exists('blank_pdf', $oldValues)) {
            $oldValues['blank_pdf'] = (int)$oldValues['blank_pdf'];
        }

        if (key_exists('blank_pdf', $newValues)) {
            $newValues['blank_pdf'] = (int)$newValues['blank_pdf'];
        }

        if (key_exists('iframe_enable', $oldValues)) {
            $oldValues['iframe_enable'] = (int)$oldValues['iframe_enable'];
        }

        if (key_exists('iframe_enable', $newValues)) {
            $newValues['iframe_enable'] = (int)$newValues['iframe_enable'];
        }
