...
class Pinboard extends AuditableModel implements HasMedia, LikeableContract
{
    ...
    public function transformAudit(array $data): array
    {
        ...
        if (key_exists('notify_email', $oldValues)) {
            $oldValues['notify_email'] = (int)$oldValues['notify_email'];
        }

        if (key_exists('notify_email', $newValues)) {
            $newValues['notify_email'] = (int)$newValues['notify_email'];
        }
