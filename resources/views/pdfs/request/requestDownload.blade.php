                            ...
                            <td width="100%" class="no_border">
                                <table class="inner_table" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border_btm">
                                                <strong>@lang('models.request.category_options.component'):</strong>
                                            </td>
                                            ...
                                            @if( (!empty($category['room']) && $category['room'] == 1) ||
                                            (!empty($subCategory['room']) && $subCategory['room'] == 1) )
                                            <td class="border_btm">
                                                <strong>@lang('models.request.category_options.room'):</strong></td>
                                            <td class="border_btm">
                                ...
                                <table class="info_table" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border_btm">
                                                <strong>@lang('models.resident.mobile_phone'):</strong></td>
                                            <td class="border_btm">{{ $resident->mobile }}</td>
                                            @else
                                            <td class="border_btm">
                                                <strong>@lang('models.resident.private_phone'):</strong></td>
                                        ...
                                        <tr>
                                            <td colspan="5" class="no_border">
                                                <h4 style="font-size: 14px; margin-bottom: 45px;">@lang('models.request.attachments'):</h4>
                                            </td>
                                        </tr>
                                        <tr>

                                               
                                            <td colspan="5"  class="no_border" style="text-align: center;">
                                        ...
                                        <tr >
                                            <td colspan="4" class="no_border" width="100%" style="margin-top:50px;">
                                                <span
                                                    style="margin-top:20px;border-bottom:2px dotted #888;padding-bottom:30px;display:inline-block;width:48%;float:left;">
                                                    @lang('models.request.download_pdf.customer_signature')
                                                </span>
                                                <span
                                                    style="margin-top:20px;border-bottom:2px dotted #888;padding-bottom:30px;display:inline-block;width:48%;float:right;">
