                        ...
                        <tr>
                            <td class="no_border" width="100%">
                                <table class="info_table" width="100%">
                                    <tbody>
                                        <tr>
                                            <td class="no_border"><strong>@lang('general.name'):</strong> {{ $resident->user->name }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border_btm">
                                                <strong>@lang('models.resident.mobile_phone'): {{ $resident->mobile }}</strong></td>
                                            @else
                                            <td class="border_btm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="no_border" width="100%" style="margin:50px 0;">
                                                    <span
                                                        style="margin-top:20px;border-bottom:2px dotted #888;padding-bottom:30px;display:inline-block;width:90%;float:left;">
