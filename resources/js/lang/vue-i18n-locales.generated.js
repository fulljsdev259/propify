export default {
    "de": {
        ...
        "general": {
            ...
            "resident_detail": {
                ...
                "not_active_resident": "Resident ist nicht aktiv und kann das Passwort nicht ändern."
            },
            "page_not_found": {
    ...
    "en": {
        ...
        "resident": {
            ...
            "placeholder": {
                ...
                "upload": "Upload files",
                "search_listing": "Search for a listing",
                "category": "Select category",
            ...
            "no_data": {
                ...
                "listing": "No listings available yet",
                ...
                "pinboard": "No pinboard available yet."
            },
            "no_data_info": {
                "listing": "All of them will be listed here.",
                ...
                "pinboard": "All of them will be listed here."
            },
            "notifications": {
                ...
                "pinboard": "Receive notification when someone comments on or liked a pinboard you post.",
                "listing": "Receive notification when someone comments on or submits a request for an ad you pinboard."
            },
            "tooltips": {
                "edit_pinboard": "Edit pinboard",
                "delete_pinboard": "Delete pinboard",
                "status_change_requeset": "Here you can change the status of request."
            },
            "descriptions": {
                "address": "Your pinboard will be visible for residents on your address only.",
                "quarter": "Your pinboard will be visible for residents within your quarter only.",
                "all": "Your pinboard will be able to be seen by everyone."
            },
            "heading_info": {
                "property_manager": "Contact person for your concerns",
                "my_neighbour": "Residents from the neighbourhood",
                "pinboard": "Current pinboard around your accommodation",
                "request": "Buy a ticket for your request",
                "listing": "Current offers from your neighbourhood",
            ...
            "add_pinboard": "Add a pinboard",
            "edit_pinboard": "Edit a pinboard",
            ...
            "get_in_touch_info": "Use the above button to get to know how you may contact the seller in order to get this listing.",
            "free": "Free",
        ...
        "template": {
            ...
            "resident_title_mr": "Mr",
            "resident_title_mrs": "Mrs",
            "resident_title_company": "Company",
    ...
    "fr": {
        "auth": {
            ...
            "benefit_2": {
                "title": "Transmission numérique des demandes",
                "description": "Vous pouvez saisir et transférer toutes vos demandes via l'application. L'équipe de direction prendra immédiatement les mesures nécessaires."
            },
            "benefit_3": {
            ...
            "benefit_4": {
                ...
                "description": "Si vous avez des objets dont vous n'avez pas besoin, vous pouvez les écrire dans l'application et les offrir à vos voisins."
            },
            "login": {
                "activate_account": {
        ...
        "resident": {
            ...
            "fetching_message": {
                "contact": "Récupérer les contacts",
                "contract": "Récupérer votre contrat",
                "document": "Récupération des documents",
                "personal_data": "Récupération de vos données personnelles"
            },
            "placeholder": {
                ...
                "search_listing": "Rechercher un produit",
                "category": "Sélectionnez une catégorie",
            ...
            "no_data": {
                ...
                "notification": "Vous n'avez pas encore de notifications",
                "media": "Il n'y a pas de fichiers médias disponibles.",
                "listing": "Aucun produit disponible pour le moment",
                ...
                "pinboard": "Pas encore de tableau d'affichage disponible."
            },
            "no_data_info": {
                "listing": "Tous seront listés ici.",
                "notification": "Tous seront listés ici.",
                ...
                "pinboard": "Tous seront listés ici."
            },
            "notifications": {
                ...
                "pinboard": "Recevez une notification lorsque quelqu'un commente ou aime un tableau d'affichage que vous publiez.",
                "listing": "Recevez une notification lorsque quelqu'un commente ou soumet une demande pour une annonce que vous affichez dans le tableau d'affichage."
            },
            "tooltips": {
                "edit_pinboard": "Modifier le tableau d'affichage",
            ...
            "heading_info": {
                ...
                "pinboard": "Tableau d'affichage actuel autour de votre logement",
                "request": "Acheter un billet pour votre demande",
                "listing": "Offres actuelles de votre quartier",
            ...
            "add_pinboard": "Ajouter un panneau d'affichage",
            "edit_pinboard": "Modifier un tableau d'affichage",
            "add_request": "Ajouter une demande",
            "add_listing": "Ajouter un produit",
            "edit_listing": "Modifier un produit",
            ...
            "latest_pinboard": "Dernier panneau d'affichage",
            "latest_listings": "Derniers produits",
            ...
            "filters": "Filtres",
            "all": "Tous",
            "my_pinboard": "Mon tableau d'affichage",
    ...
    "it": {
        "auth": {
            ...
            "title": "Tutto è più facile con la nostra app residente",
            "intro": "Al fine di trattare le preoccupazioni dei nostri residenti ancora più velocemente, i nostri residenti hanno accesso ad un'area protetta con la quale è possibile gestire digitalmente la locazione. Attraverso l'elaborazione digitale possiamo agire ancora più velocemente e creare trasparenza per tutte le parti coinvolte.",
            "benefit_1": {
            ...
            "login": {
                "activate_account": {
                    ...
                    "description": "Dopo aver ricevuto il codice di attivazione, è possibile accedere per la prima volta al portale dei residenti e attivare il proprio account."
                }
            }
        },
        "dashboard": {
        ...
        "models": {
            "user": {
                ...
                "requestCategorySaved": "Categoria della richiesta di servizio salvata",
                "requestCategoryDeleted": "Categoria della richiesta di servizio cancellata",
                "errors": {
                    "not_found": "Utente non trovato",
        ...
        "resident": {
            ...
            "placeholder": {
                ...
                "upload": "Carica file",
                "search_listing": "Cerca un prodotto.",
                "category": "Selezionare la categoria",
            ...
            "no_data": {
                ...
                "listing": "Non sono ancora disponibili prodotti",
                ...
                "pinboard": "Non è ancora disponibile una bacheca."
            },
            "no_data_info": {
                "listing": "Tutti loro saranno elencati qui.",
                ...
                "pinboard": "Tutti loro saranno elencati qui."
            },
            "notifications": {
                ...
                "pinboard": "Ricevi una notifica quando qualcuno commenta o ha gradito una bacheca che pubblichi.",
                "listing": "Ricevi una notifica quando qualcuno commenta o invia una richiesta di una bacheca pubblicitaria."
            },
            "tooltips": {
                "edit_pinboard": "Modifica bacheca",
            ...
            "heading_info": {
                ...
                "pinboard": "Pannelli informativi attuali intorno all'alloggio",
                "request": "Acquista un biglietto per la tua richiesta",
                "listing": "Offerte attuali del vostro quartiere",
            ...
            "add_pinboard": "Aggiungere una bacheca",
            "edit_pinboard": "Modifica di una bacheca",
            "add_request": "Aggiungi una richiesta",
            "add_listing": "Aggiungi un prodotto",
            "edit_listing": "Modificare un prodotto",
            ...
            "operating_instructions": "Istruzioni per l'uso",
            "care_instructions": "Istruzioni per la cura",
            "pinboard": "Lavagna a fogli mobili",
            "listing": "Mercato",
            "admin": "Ammin",
            "address": "Indirizzo",
            "refresh": "Rinfresca",
        ...
        "template": {
            ...
            "resident_title_mr": "Sig.",
            "resident_title_mrs": "Signora",
            "resident_title_company": "L'azienda",
            ...
            "activate_account": "Attivare l'account",
            "resident_portal": "Portale dei residenti",
            "generated_email_for_user": "Questa e-mail è stata generata automaticamente per {userName}.",
            "generated_email_for_company": "Riceverai questa e-mail generata automaticamente come utente del portale {companyName} resident portal. Il portale residente è gestito da Propify AG.",
            "links": "<a href=\"#\" style=\"color: #000000 \">Impressum </a>&ensp; | &ensp;<a href=\"#\" style=\"color: #000000 \">Condizioni di utilizzo</a>&ensp; | &ensp;<a href=\"#\" style=\"color: #000000 \">Dichiarazione sulla privacy</a>"
        },
        "validation": {
