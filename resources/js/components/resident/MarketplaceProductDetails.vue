<template>
    <div class="listing-details">
        ...
        <el-tabs value="overview">
            <el-tab-pane name="overview" :label="$t('resident.overview')">
                <div class="container">
                    <div class="heading">
                        {{data.title}}
                        <small class="time">
                    ...
                    <div class="price">
                        <span v-if="isFree">
                            <div class="content">{{$t('resident.free')}}</div>
                        </span>
                        <template v-else>
                            <div class="title">{{$t('resident.price')}}</div>
                            <div class="content">
                ...
                <template v-else>
                    ...
                    <small class="hint">{{$t('resident.get_in_touch_info')}}</small>
                </template>
            </el-tab-pane>
            <el-tab-pane name="comments" :label="$t('resident.comments')" lazy>
