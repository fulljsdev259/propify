                    ...
                    <el-col :lg="12" :sm="24">
                        <card :loading="loading" :header="$t('models.resident.personal_details_card')">
                            <el-row :gutter="20">
                                ...
                                <el-col :md="12">
                                    <el-form-item :label="$t('models.resident.first_name')" :rules="validationRules.first_name"
                                                  prop="first_name">
                                        <el-input autocomplete="off" type="text" v-model="model.first_name"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :md="12">
                                    <el-form-item :label="$t('models.resident.last_name')" :rules="validationRules.last_name"
                                                  prop="last_name">
