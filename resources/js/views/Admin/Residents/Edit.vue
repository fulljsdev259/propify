        ...
        <div class="residents-edit mb20 residents-edit-new">
            ...
            <ui-drawer :visible.sync="visibleDrawer" :z-index="1" direction="right" docked>
                ...
                <div class="content" v-if="visibleDrawer">
                    <contract-form v-if="editingContract" :hide-building-and-units="true" mode="edit" :data="editingContract" :resident_id="model.id" :visible.sync="visibleDrawer" :edit_index="editingContractIndex" @update-contract="updateContract" :used_units="used_units"/>
