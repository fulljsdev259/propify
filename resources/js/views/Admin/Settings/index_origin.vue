        ...
        computed: {
            ...
            validationRules() {
                ...
                return {
                    ...
                    iframe_url: [{
                        type: 'url',
                        message: this.$t("settings.iframe_url.validation")
                    }],
                    cleanify_email: [{
                        type: 'email',
                        message: this.$t("settings.cleanify_email.validation")
                    }],
                    mail_from_name: [{
                        required: true,
                        message: this.$t("settings.mail_from_name.validation")
                    }],
                    mail_from_address: [{
                        required: true,
                        message: this.$t("settings.mail_from_address.required")
                    },
                        {
                            type: 'email',
                            message: this.$t("settings.mail_from_address.email")
                        }
                    ],
                    mail_host: [{
                        required: true,
                        message: this.$t("settings.mail_host.validation")
                    }],
                    mail_port: [{
                        required: true,
                        message: this.$t("settings.mail_port.validation")
                    }],
                    mail_username: [{
                        required: true,
                        message: this.$t("settings.mail_username.validation")
                    }],
                    mail_password: [{
                        required: true,
                        message: this.$t("settings.mail_password.validation")
                    }],
                    mail_powered_by: [{
                        required: true,
                        message: this.$t("settings.mail_powered_by.validation")
                    }],
                }
            }
        },
