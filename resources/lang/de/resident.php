...
return [
    ...
    "fetching_message" => [
        ...
        "relation" => "Abrufen des Mietvertrages...",
    ...
    "no_data_info" => [
        ...
        "relation" => "Alle werden hier aufgelistet.",
    ...
    'my_recent_relation' => 'Mietvertrag',
    'documents' => 'Objekt-Dokumentation',
    'my_contact_persons' => 'Kontaktpersonen',
    ...
    "default_relation_id" => "Standard-Vertrags-ID",
    ...
    "default_relation_expired" => "Ihr letzter Standardvertrag ist abgelaufen, Sie sollten einen anderen Vertrag auswählen.",
    "cleanify" => "Cleanify"
];