...
return [
    ...
    'resident' => [
        ...
        'relation' => [
            ...
            'relation_id' => 'Vertrags-ID',
            'status' => [
                'active' => 'Aktiv',
                'inactive' => 'Inaktiv',
            ],
            'add' => 'Vertrag erstellen',
            'add_sell_relation' => 'Verkaufsvertrag hinzufügen',
    ...
    'building' => [
        ...
        'errors' => [
            'not_found' => "Objekt nicht gefunden.",
            'manager_not_found' => "Mitarbeiter nicht gefunden",
            'deleted' => "Fehler beim Löschen von Mediendateien: ",
            'manager_assigned' => "Fehler beim Zuweisung des Mitarbeiters: ",
            'provider_deleted' => "Fehler beim Entfernen des Mitarbeiters: ",
        ],
    ...
    'request' => [        
        ...
        'mass_edit' => [
            ...
            'options' => [
                ...
                'property_manager' => 'Mitarbeiter',
                'change_status' => 'Status ändern'
            ],
            'service_provider' => [
                'modal' => [
                    'heading_title' => 'Dienstleister zuweisen',
                    'content_label' => 'Sie können hier Dienstleister auswählen und diese zuweisen. ',
                    'footer_button' => 'Ausführen',
                    'switcher_label' => 'Benachrichtigung von Dienstleistern',
                    'switcher_desc' => 'Sie können den betroffenen Dienstleistern eine E-Mail mit einer Zusammenfassung der Mängel senden. ',
                ]
            ],
            'property_manager' => [
                'modal' => [
                    'heading_title' => 'Verantwortliche Person zuweisen',
                    'content_label' => 'Sie können hier Mitarbeiter auswählen und diese zuweisen.',
                    'footer_button' => 'Ausführen',
                ]
            ],
            'change_status' => [
                'modal' => [
                    'heading_title' => 'Statusänderung vornhemen',
                    'content_label' => 'Wählen Sie den gwünschten Status.',
                    'footer_button' => 'Ausführen',
                ]
            ],
        ],
    ...
    'property_manager' => [
        ...
        'delete_with_reassign_modal' => [
            ...
            'description' => 'Der gewählte Mitarbeiter ist mit Objekten verbunden. Sie können die Objekte an eine anderen Person zuweisen. Wählen Sie hierzu einen Mitarbeiter aus der Liste aus.',
            'search_title' => 'Mitarbeiter suchen',
        ],
        ...
        'errors' => [
            ...
            'create' => "Fehler beim Erstellen des Mitarbeiters: ",
            'update' => "Fehler beim Aktualisieren des Mitarbeiters:",
            'quarter_not_found' => "Projekt nicht gefunden",
            'building_not_found' => "Objekt nicht gefunden",
    ...
    //     'delete_with_reassign_modal' => [
    //         'title' => 'Andere Person zuweisen und dann Benutzer löschen',
    //         'description' => 'Der ausgewählte Eigentümer ist mit Immobilien verknüpft. Sie können die Eigenschaften einer anderen Person zuordnen. Wählen Sie dazu einen Hausbesitzer aus der Liste aus.',
    //         'search_title' => 'Suche Eigentümer',
    //     ],
    //     'delete_without_reassign' => 'Löschen',
    //     'profile_card' => 'User Profile',
    //     'social_card' => 'Social Media',
    ...
    //     'errors' => [
    //         'not_found' => "Eigentümer nicht gefunden",
    //         'create' => "Eigentümer erstellen Fehler: ",
    //         'update' => "Eigentümer aktualisierter Fehler: ",
    //         'quarter_not_found' => "Projekt nicht gefunden",
    //         'building_not_found' => "Objekt nicht gefunden",
    //         'building_already_assign' => "Edificio già assegnato per tutto il trimestre",
    //         'building_assign_deleted_house_owner' => "Sie können einem gelöschten Eigentümer keine Gebäude zuordnen.",
    //         'deleted' => "Eigentümer hat den Fehler gelöscht: ",
    //     ],
    // ],
    'listing' => [
        'title' => 'Marktplatz',
