...
return [
    ...
    "fetching_message" => [
        ...
        "relation" => "Fetching your contract...",
    ...
    "no_data_info" => [
        ...
        "relation" => "All of them will be listed here.",
    ...
    'my_recent_relation' => 'My recent contract',
    'documents' => 'Documents',
    ...
    "default_relation_id" => "Default Contract ID",
    ...
    "default_relation_expired" => "Your last default contract is expired, You should select another contract.",
    "cleanify" => "Cleanify"
];