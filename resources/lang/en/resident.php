...
return [
    ...
    "fetching_message" => [
        ...
        "relation" => "Fetching your relation...",
    ...
    'my_recent_relation' => 'My recent relation',
    'documents' => 'Documents',
    ...
    "default_relation_id" => "Default Relation ID",
    ...
    "default_relation_expired" => "Your last default relation is expired, You should select another relation.",
    "cleanify" => "Cleanify"
];