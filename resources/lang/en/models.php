...
return [
    ...
    'settings' => [
        ...
        'gocaution' => [
            'label' => 'Gocaution',
            'description' => 'The deposit guarantee does not require the deposit of a rental deposit. Both tenants and landlords benefit from the cashless rental deposit from goCaution.',
        ],
        'iframe_url' => [
            'label' => 'Iframe URL',
