...
return [
    ...
    "fetching_message" => [
        ...
        "relation" => "Recupero del contratto",
    ...
    "no_data_info" => [
        ...
        "relation" => "Tutti loro saranno elencati qui.",
    ...
    'my_recent_relation' => 'Il mio recente contratto',
    'documents' => 'Documenti',
    ...
    "relation_file" => "Fascicolo contrattuale",
    ...
    "default_relation_id" => "ID contratto predefinito",
    ...
    "default_relation_expired" => "Il tuo ultimo contratto di default è scaduto, dovresti selezionare un altro contratto.",
    "cleanify" => "Pulire"
];