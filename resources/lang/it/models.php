...
return [
    ...
    'unit' => [
        ...
        'validation' => [
            ...
            'resident' => [
                "required" => "Il residente è richiesto",
            ]
        ],
        'errors' => [
            'not_found' => "Unità non trovata",
    ...
    'settings' => [
        ...
        'cleanify_email' => [
            ...
            'validation' => 'Cleanify Email dovrebbe essere valida',
        ],
        'cleanify_url' => [
            'label' => "Pulire l'URL e-mail",
            'validation' => "Pulire l'URL di posta elettronica dovrebbe essere un URL valido",
        ],
        'gocaution' => [
            'label' => 'Gocauzione',
