...
return [
    ...
    "fetching_message" => [
        ...
        "relation" => "Récupérer votre contrat",
    ...
    "placeholder" => [
        ...
        "relation" => "Sélectionner un contrat",
    ...
    "no_data_info" => [
        ...
        "relation" => "Tous seront listés ici.",
    ...
    'my_recent_relation' => 'Mon récent contrat',
    'documents' => 'Les documents',
    'my_contact_persons' => 'Personnes de contact',
    ...
    "relation_file" => "Dossier du contrat",
    ...
    "default_relation_id" => "ID de contrat par défaut",
    ...
    "default_relation_expired" => "Votre dernier contrat par défaut est expiré, vous devez sélectionner un autre contrat.",
    "cleanify" => "Nettoyer"
];